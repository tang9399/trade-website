...
const i18n = {
    ...
    'en': {
        ...
        'products.p3.desc': 'Professional business reception team providing translation, market visits, factory inspections and business negotiation support.',
        ...
        'gallery.item4': 'Industry Exhibition',
        'gallery.item5': 'Market Sourcing',
        'gallery.item6': 'Yiwu Trade Market',
        'gallery.item7': 'Yiwu Market District 5',
    ...
    'ru': {
        ...
        'hero.subtitle': 'Бизнес-прием · Комплексный sourcing · Международная логистика · Глобальная доставка',
        ...
        'products.p3.title': 'Бизнес-прием',
        'products.p3.desc': 'Профессиональная команда по бизнес-приему: перевод, посещение рынков, инспекция заводов и переговоры.',
        ...
        'gallery.item1': 'Визит на фабрику',
        'gallery.item2': 'Инспекция товаров',
        'gallery.item3': 'Китайско-европейская команда',
        'gallery.item4': 'Отраслевая выставка',
        'gallery.item5': 'Закупки на рынке',
        'gallery.item6': 'Торговый центр Иу',
        'gallery.item7': 'Торговый центр Иу, р-н 5',
        'gallery.item8': 'Приём клиентов',
        ...
        'cases.p9': 'TOP-основатель Казахстана',
        'cases.p10': 'Магазин клиента 2',
